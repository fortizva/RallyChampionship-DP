...
/**
 * Simulación que concluye normalmente completandose todas las carreras.
 * 
...
public class DatosCampeonatoCompleto
{
    ...
    private void initData() {
        ...
        Escuderia escPeugeot = new Escuderia("PEUGEOT", new ComparadorAnidadoPiloto(new ComparadorPuntosPiloto(), new ComparadorDestrezaPiloto(), new ComparadorNombrePiloto()), new ComparadorAnidadoCoche(new ComparadorCombustibleActualCoche(), new ComparadorNombreCoche()));
        escPeugeot.inscribirse();
        Escuderia escCitroen =new Escuderia("CITRÖEN", new ComparadorAnidadoPiloto(true, new ComparadorPuntosPiloto(), new ComparadorDestrezaPiloto(), new ComparadorNombrePiloto()), new ComparadorAnidadoCoche(true, new ComparadorCombustibleActualCoche(), new ComparadorNombreCoche()));
        escCitroen.inscribirse();
        Escuderia escSeat =new Escuderia("SEAT", new ComparadorAnidadoPiloto(new ComparadorPuntosPiloto(), new ComparadorDestrezaPiloto(), new ComparadorNombrePiloto()), new ComparadorAnidadoCoche(new ComparadorCombustibleActualCoche(), new ComparadorNombreCoche()));
        escSeat.inscribirse();
