...
public class DatosCampeonatoFinPrematuro
{
    ...
    private void initData() {
        ...
        Organizacion.inicializar(1, 3, (new ComparadorAnidadoCircuito(new ComparadorComplejidadActualCircuito().reversed(), new ComparadorNombreCircuito())));
        ...
        Escuderia escPeugeot = new Escuderia("PEUGEOT", new ComparadorAnidadoPiloto(true, new ComparadorPuntosPiloto(), new ComparadorDestrezaPiloto(), new ComparadorNombrePiloto()), new ComparadorAnidadoCoche(true, new ComparadorCombustibleActualCoche(), new ComparadorNombreCoche()));
        ...
        Escuderia escSeat =new Escuderia("SEAT", new ComparadorAnidadoPiloto(true, new ComparadorPuntosPiloto(), new ComparadorDestrezaPiloto(), new ComparadorNombrePiloto()), new ComparadorAnidadoCoche(true, new ComparadorCombustibleActualCoche(), new ComparadorNombreCoche()));
        escSeat.inscribirse();
